...
#SBATCH -o /dli/data/logs/%j.out
#SBATCH -e /dli/data/logs/%j.err
...
NAME="log_2Nodes4GPUS_no_nvlink"       # <--- CHANGED HERE 
...
clear; srun --jobid $SLURM_JOBID bash -c 'NCCL_DEBUG=INFO NCCL_P2P_LEVEL=LOC   $LAUNCHER --node_rank $SLURM_PROCID $CMD' 2>&1 | tee -a $LOGS_PATH/$NAME.txt
